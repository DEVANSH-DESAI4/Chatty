      ...
      body: _isLoading
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                    ...
                    child: ListTile(
                      ...
                      leading: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.purple.shade100, // Changed from purple.shade100 to purple.shade100
                          borderRadius: BorderRadius.circular(25),
                        ),
                        child: const Icon(
                          Icons.smart_toy,
                          color: Colors.purple, // Changed from purple to purple
                          size: 28,
                        ),
                      ),
                      title: const Text(
                ...
                // Update the drawer
                ListTile(
                  leading: const Icon(Icons.smart_toy, color: Colors.purple), // Changed from purple to purple
